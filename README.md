...
| 多人协作 | 邀请注册或由管理员新建账号；权限只区分可编辑和仅查看 |
| 简便登录 | 成员可使用中文姓名或手机号码登录，初始密码可设为手机号码，管理员可重置普通成员密码 |
| 家族资料 | 记录家谱名称、家族发源地和家族介绍；上传 DOC、DOCX、PDF 电子族谱并在线预览或下载 |
...
- 仓库、发行压缩包和容器镜像不包含现有家谱中的人物、关系、账号、照片、文献、碑记、邀请、分享链接或历史备份。
- 正式部署首次启动只创建通用家谱设置和初始管理员，不预置人物或专属分支。
- 业务数据保存在自己的持久化目录中；升级镜像不会主动清空已有数据。
- 备份包含人物资料和账号密码哈希，请妥善保存，不要上传到公开仓库。
...
Contact me: [weixi1004@gmail.com](mailto:weixi1004@gmail.com)

## 参与项目

欢迎提交问题和改进建议。报告问题时请附上版本、部署方式、复现步骤和已经脱敏的截图，不要上传真实家谱数据库、邀请链接或会话信息。

[贡献指南](CONTRIBUTING.md) · [安全问题反馈](SECURITY.md) · [Issues](https://github.com/91godlike/zongpu/issues)
